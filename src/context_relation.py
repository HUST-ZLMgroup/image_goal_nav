"""Context-style encoding and pair-relation classification."""
...
from src.aggregation import create_pooling_layer
...
class ContextStyleEncoder(nn.Module):
#     __factory = {
...
#     }
    ...
    def __init__(self, pretrained=True, cut_at_pooling=False,
        ...
        super(ContextStyleEncoder, self).__init__()

        # self.depth = depth
        self.pretrained = pretrained
        self.cut_at_pooling = cut_at_pooling

        resnet = ContextResNet()
        ...
        self.gap = create_pooling_layer(pooling_type)
...
class PairRelationClassifier(nn.Module):
    """Classify the contextual relation between a pair of image features."""
    def __init__(self):
        super(PairRelationClassifier, self).__init__()
...
def load_matching_weights(fpath, model, strip=None):
