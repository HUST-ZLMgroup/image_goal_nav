"""Navigation reward and evaluation measures."""
...
from src.task_sensors import TargetViewSensor
cv2 = try_cv2_import()


@registry.register_measure
class GoalHeadingError(Measure):
...
@registry.register_measure
class ProgressHeadingReward(Measure):

    cls_uuid: str = "heading_progress_reward"
...
@registry.register_measure
class PoseGoalDistance(Measure):
    r"""
    """

    cls_uuid: str = "pose_goal_distance"
...
@registry.register_measure
class PoseGoalSuccess(Measure):
    r"""
    """

    cls_uuid: str = "pose_goal_success"
