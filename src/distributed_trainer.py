...
"""PPO and distributed PPO training orchestration."""
...
from src.agent_policy import GoalConditionedPolicy
from src.frame_rendering import compose_observation_frame
...
@baseline_registry.register_trainer(name="distributed-goal-navigation")
class DistributedNavigationTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        policy: GoalConditionedPolicy = baseline_registry.get_policy(
    ...
    def _resume_config(self, resume_state=None):
        ...
        if resume_state is not None:
            unmatch_config = experiment_setup.find_config_differences(
    ...
    def _init_train(self, resume_state=None):
        ...
        if self._is_distributed:
            ...
            local_rank, tcp_store = initialize_distributed_backend(
        ...
        while (
            ...
            for i in range(n_envs):
                if len(self.config.habitat_baselines.video_option) > 0 and infos is not None:
                    ...
                    frame = compose_observation_frame(
    ...
    def traverse(self):
        ...
        start_tt = time.time()
        processor = getattr(
            experiment_setup, self.config.habitat.traverse.processor
        )(self.config)
